...
# (HARD) Example: {"Project Manage": 4, "Machine Learning Engineer": 3, ...}

# Task 1
# Print the name of the person who has the highest salary at the company
highest_earner = employees[0]
...
# Task 2
# Print the combined years of experiences of all employees at the company
experience = 0
...
for employee in employees:
    if(employee["department"] == "Product"):
        product_salary += employee["salary"]
    elif(employee["department"] == "Business"):
        business_salary += employee["salary"]
print(product_salary)
print(business_salary)
